...
try {
    ...
    let result = parseInt("abc"); // Isso não é um número válido
    console.log(result); // Não será executado se ocorrer um erro
} catch (error) {
    // Este bloco será executado se ocorrer um erro
    console.error("Erro ao converter a string em número:", error.message);
